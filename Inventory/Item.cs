...
public class Item : MonoBehaviour
{
    ...
    public void SetItem(int id, int templateID, string name, int itemType, int durability, int maxDurability, float damage, float speed, int weaponType, int slotType, float slashRes, float thrustRes, float crushRes, float heatRes,
